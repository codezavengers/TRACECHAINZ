...
CONTACT: le-compliance@tracechain.gov.in / emergency-desk@cyberpolice.gov.in`;
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      {/* Document Preview */}
      <div className="rounded-xl border border-white/10 bg-[#161a24] p-6 space-y-4">
        <div className="flex items-center justify-between border-b border-white/10 pb-3">
          <div className="flex items-center gap-2 text-xs font-semibold text-white">
            <Scale className="size-4 text-amber-400" />
            Official Law Enforcement Freeze Subpoena Preview
          </div>
        ...
        <pre className="rounded-xl bg-black/60 border border-white/10 p-5 font-mono text-xs text-slate-300 overflow-x-auto whitespace-pre-wrap leading-relaxed">
          {noticeText}
        </pre>
      </div>
    </div>
