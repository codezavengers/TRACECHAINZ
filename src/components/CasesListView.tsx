    ...
    <div className="space-y-5 animate-in fade-in duration-200">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-xl bg-amber-400 hover:bg-amber-300 px-4 py-2.5 text-sm font-semibold text-black transition shadow-lg shadow-amber-400/20 shrink-0"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-3 rounded-xl border border-white/10 bg-[#161a24] p-3.5">
        <div className="relative md:col-span-2">
          ...
          <input
            ...
            className="w-full rounded-lg border border-white/10 bg-black/30 pl-9 pr-3 py-2 text-xs text-white placeholder-slate-500 focus:border-amber-400 focus:outline-none"
          />
        </div>
        ...
        <select
          ...
          className="rounded-lg border border-white/10 bg-black/30 px-3 py-2 text-xs text-white focus:border-amber-400 focus:outline-none"
        >
        ...
        {filteredCases.length === 0 ? (
          ...
          filteredCases.map((c) => (
            <div
              ...
              className="group rounded-xl border border-white/10 bg-[#161a24] p-4.5 transition-all hover:border-amber-400/40 hover:bg-[#1a202c] cursor-pointer"
            >
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                <div className="space-y-2 min-w-0 flex-1">
                  <div className="flex items-center gap-2.5 flex-wrap">
                    <span className="font-mono text-xs font-bold text-amber-400 px-2.5 py-0.5 rounded bg-amber-400/10 border border-amber-400/20">
                      {c.id}
                    </span>
                  ...
                  <div className="flex items-center gap-2 flex-wrap text-xs pt-1">
                    ...
                    <span className="px-2.5 py-0.5 rounded text-[11px] font-medium bg-white/5 border border-white/10 text-slate-300">
                      {STATUS_LABEL[c.status]}
                    </span>

                    <span className="px-2.5 py-0.5 rounded text-[11px] font-medium bg-white/5 border border-white/10 text-slate-300 uppercase">
                      {CHAIN_LABEL[c.chain]}
                    </span>
                ...
                <div className="flex items-center justify-between lg:justify-end gap-6 border-t lg:border-t-0 border-white/5 pt-3 lg:pt-0 shrink-0">
                  ...
                  <div className="flex flex-col items-center justify-center w-14 h-14 rounded-full border border-amber-400/30 bg-amber-400/5">
                    <span className="text-[10px] uppercase text-slate-400 font-semibold">Priority</span>
                    <span className="text-base font-bold font-mono text-amber-400">{c.priorityScore}</span>
                  </div>

                  <ChevronRight className="size-5 text-slate-400 group-hover:translate-x-1 group-hover:text-amber-400 transition" />
                </div>
              </div>
            </div>
          ))
